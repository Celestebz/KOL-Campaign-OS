...
test('MySQL migration, concurrent claims, rollback and resume', { skip: process.env.DISCOVERY_MYSQL_TEST !== '1' }, async () => {
  ...
  try {
    ...
    await q("INSERT INTO kol_strategies VALUES (1, 1, 1, 'Test strategy', 'ready')");
    const { getService, createDiscoveryService } = require('./discoveryRequests');
    const service = getService();
    const body = { request_key: 'integration-1', strategy_id: 1, target_platform: 'tiktok', target_count: 10, requirements: 'US home creators' };
